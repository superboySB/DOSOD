...
def parse_args():
    ...
    parser.add_argument('--version', default='v2', type=str, help='yolo world version (v1 or v2)')
    parser.add_argument(
        '--text-embed',
...
def reparameterize_neck(state_dict, embeds, type='conv', version='v2'):
    ...
    if version == 'v1':
        N, D = embeds.shape
        state_dict['neck.text_embeddings'] = embeds.view(1, N, D)
